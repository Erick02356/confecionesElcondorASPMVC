...
namespace confecionesElcondorMVC.Controllers
{
    public class AreasController : Controller
    {
        ...
        public AreasController(ConfeccionesElCondorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdArea,NombreArea")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdArea,NombreArea")] Area area)
        {
            if (id != area.IdArea)
            {
                return NotFound();
